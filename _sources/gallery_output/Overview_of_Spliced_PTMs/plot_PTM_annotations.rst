...
.. "gallery_output/Overview_of_Spliced_PTMs/plot_PTM_annotations.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_gallery_output_Overview_of_Spliced_PTMs_plot_PTM_annotations.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_gallery_output_Overview_of_Spliced_PTMs_plot_PTM_annotations.py:
...
.. image-sg:: /gallery_output/Overview_of_Spliced_PTMs/images/sphx_glr_plot_PTM_annotations_001.png
   :alt: plot PTM annotations
   :srcset: /gallery_output/Overview_of_Spliced_PTMs/images/sphx_glr_plot_PTM_annotations_001.png
    ...
    <table border="1" class="dataframe">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>981.0</td>
          <td>Phosphorylation</td>
          <td>activity, inhibited;molecular association, reg...</td>
          <td>-0.219</td>
...
.. _sphx_glr_download_gallery_output_Overview_of_Spliced_PTMs_plot_PTM_annotations.py:
